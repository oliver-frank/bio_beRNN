...
for participant in participants:
    ...
    for task in tasks:
        ...
        '''
        atlas, mode  = datasets.fetch_atlas_msdl(data_dir=data_dir), 'basc' # 39 regions - broader cognitive function like default mode network, visual and motor; based on resting state
