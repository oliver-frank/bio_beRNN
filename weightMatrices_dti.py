...
def run_pipeline(base_path):
    ...
    np.save(os.path.join(out_path, f'connectome_{participant}_300.npy'), conn_matrix)
    ...
    for res in [256, 128, 64, 32]:
        ...
        np.save(os.path.join(out_path, f'connectome_{participant}_{res}.npy'), downsampled)
